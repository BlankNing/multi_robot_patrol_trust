...
assert node_pos_matrix.shape[0] == nodes_num, "Mismatch in number of nodes and position matrix shape."
...
if __name__ == '__main__':
    paths_filename = f'./{map_name}_neighbour1_precomputed_paths.npy'
    ...
    if os.path.isfile(paths_filename):
        ...
        np.save(paths_filename, precomputed_paths)
